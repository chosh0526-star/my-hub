...
export async function POST(req) {
  try {
    ...
    // ==========================================
    // 💡 [핵심 4] 챗봇 출격 (기록 + 사용자 질문 조합)
    // ==========================================
    const chatModel = genAI.getGenerativeModel({ 
      model: "gemini-2.5-flash",
      systemInstruction: `당신은 'The Archive' 앱의 똑똑한 AI 비서입니다.
      반드시 제공된 [저장소 기록]을 바탕으로 사용자의 질문에 답변하세요.
      기록에 있는 내용이라면 요약해서 친절하게 알려주고, 기록에 없다면 "저장된 기록 중에는 관련 내용이 없네요"라고 솔직하게 말하세요.`
    });
